            ...
            <div className="row-span-6 col-span-2 flex flex-col p-3 border rounded-xl place-content-between">
                ...
                <ResponsiveContainer
                    ...
                    >
                        ...
                        <Legend />
                        <Tooltip formatter={(v: number, n: string) => [`€${v.toLocaleString()}`, n]} contentStyle={{ background: "#18181b", border: "1px solid #3f3f46", borderRadius: 12, color: "white" }} labelStyle={{ color: "#d4d4d8" }}/>
                    </PieChart>
                </ResponsiveContainer>
            </div>
            <div className="row-span-4 col-span-2 flex flex-col p-3 border rounded-xl place-content-between">
